...
public class YXMediaManager implements
    ...
    public static YXMediaManager instance() {
        if (JCMediaManager == null) {
            JCMediaManager = new YXMediaManager();
        }
        return JCMediaManager;
    }

    public YXMediaManager() {
            ...
            switch (msg.what) {
                case HANDLER_PREPARE:
                    try {
                        ...
                        mediaPlayer.setOnPreparedListener(YXMediaManager.this);
                        mediaPlayer.setOnCompletionListener(YXMediaManager.this);
                        mediaPlayer.setOnBufferingUpdateListener(YXMediaManager.this);
                        mediaPlayer.setScreenOnWhilePlaying(true);
                        mediaPlayer.setOnSeekCompleteListener(YXMediaManager.this);
                        mediaPlayer.setOnErrorListener(YXMediaManager.this);
                        mediaPlayer.setOnInfoListener(YXMediaManager.this);
                        mediaPlayer.setOnVideoSizeChangedListener(YXMediaManager.this);
        ...
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (YXVideoPlayerManager.getCurrentJcvd() != null) {
                    YXVideoPlayerManager.getCurrentJcvd().onPrepared();
                }
            }
        });
    }
    ...
    public void onCompletion(MediaPlayer mp) {
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (YXVideoPlayerManager.getCurrentJcvd() != null) {
                    YXVideoPlayerManager.getCurrentJcvd().onAutoCompletion();
                }
            }
        });
    }
    ...
    public void onBufferingUpdate(MediaPlayer mp, final int percent) {
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (YXVideoPlayerManager.getCurrentJcvd() != null) {
                    YXVideoPlayerManager.getCurrentJcvd().setBufferProgress(percent);
                }
            }
        });
    }
    ...
    public void onSeekComplete(MediaPlayer mp) {
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (YXVideoPlayerManager.getCurrentJcvd() != null) {
                    YXVideoPlayerManager.getCurrentJcvd().onSeekComplete();
                }
            }
        });
    }
    ...
    public boolean onError(MediaPlayer mp, final int what, final int extra) {
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (YXVideoPlayerManager.getCurrentJcvd() != null) {
                    YXVideoPlayerManager.getCurrentJcvd().onError(what, extra);
                }
            }
        });
        return true;
    ...
    public boolean onInfo(MediaPlayer mp, final int what, final int extra) {
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (YXVideoPlayerManager.getCurrentJcvd() != null) {
                    YXVideoPlayerManager.getCurrentJcvd().onInfo(what, extra);
                }
            }
        });
        return false;
    ...
    public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
        ...
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (YXVideoPlayerManager.getCurrentJcvd() != null) {
                    YXVideoPlayerManager.getCurrentJcvd().onVideoSizeChanged();
                }
            }
        });
    }

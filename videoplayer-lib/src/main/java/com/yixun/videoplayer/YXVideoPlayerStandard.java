 ...
 * On 2016/04/18 16:15
 */
public class YXVideoPlayerStandard extends YXVideoPlayer {
    ...
    public YXVideoPlayerStandard(Context context) {
        super(context);
    }

    public YXVideoPlayerStandard(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!mChangePosition && !mChangeVolume) {
                        onEvent(YXUserActionStandard.ON_CLICK_BLANK);
                        onClickUiToggle();
                    }
                    break;
            }
        ...
        if (i == R.id.thumb) {
            ...
            if (currentState == CURRENT_STATE_NORMAL) {
                if (!url.startsWith("file") && !url.startsWith("/") &&
                        !YXUtils.isWifiConnected(getContext()) && !WIFI_TIP_DIALOG_SHOWED) {
                    showWifiDialog();
                    return;
                }
                startVideo();
    ...
    public void startVideo() {
        prepareMediaPlayer();
        onEvent(YXUserActionStandard.ON_CLICK_START_THUMB);
    }

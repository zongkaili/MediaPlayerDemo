 ...
 * On 2016/04/10 15:45
 */
public class YXVideoPlayerSimple extends YXVideoPlayer {

    public YXVideoPlayerSimple(Context context) {
        super(context);
    }

    public YXVideoPlayerSimple(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
